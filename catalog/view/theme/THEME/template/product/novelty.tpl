...
<section class="catalog_inner centered">
	...
	<div class="column-filter filter_bar">
		...
		<div class="btn btn_grad showfilters">Фильтр <img src="./catalog/view/theme/THEME/stylesheet/img/filter.svg" alt=""></div>
		<div class="btn btn_grad closefilters">Закрыть <img src="./catalog/view/theme/THEME/stylesheet/img/close_white.svg" alt=""></div>

		<div class="filters">
			<div id="sortby" class="selectbox sort_selectbox">
				<div class="val_selected sort_selected">Произвольно</div>
		...
		<?php if ($products) { ?>
				...
				<div class="book_grid">
					...
					<!-- сюда было бы хорошо вставить продукты из featured
					 -->
						...
						<div class="book_info">
							...
							<div class="price <?php if ($product['special']) { ?>sale<?php } ?>">
								<?php if ($product['price']) { ?>
									...
									<?php } else { ?>
									<span class="prop_name">Цена</span>
									<div class="price_new">
