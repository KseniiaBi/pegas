...
<ul class="breadcrumb">
  ...
  <?php } ?>
    ...
    <section id="content" class="register_inner centered">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="register">
       ...
       <!-- <fieldset id="account" class="register_fields">
          ...
          <fieldset class="register_fields form-group required">

              <label class="control-label" for="input-firstname"><?php echo $entry_firstname; ?> <sup>*</sup></label>
                <input type="text" name="firstname" id="input-firstname" required class="form-control" />
          ...
          <fieldset class="register_fields form-group required">
              <label class=" control-label" for="input-email"><?php echo $entry_email; ?><sup>*</sup></label>
...
<!-- 
        ...
        <fieldset class="register_fields form-group required">
            <label class="col-sm-2 control-label" for="input-password"><?php echo $entry_password; ?><sup>*</sup></label>
              <input type="password" name="password"  id="input-password" required class="form-control" />
...
<!--         <fieldset>
        ...
        <a class="btn btn_grad" data-onclick="submit" id="simpleregister_button_confirm">Продолжить</a>
     
      </form>
    </div>


<!-- пробросить текст на укр -->
      <div class="goto_register">
        <img src="./catalog/view/theme/THEME/stylesheet/img/newacc.svg" alt="">
        <h3>Регистрация</h3>
        <p>Если вы впервые у нас на сайте - зарегистрируйтесь и будьте в курсе всех скидок и новинок. Вся информация о заказах будет храниться в вашем личном кабинете  </p>
      </div>
