...
<?php //print_r($products); ?>
				...
				<div class="col-md-6 col-xs-12 col-md-pull-6">
					<div class="forms-order">
                        ...
                        Скрыт быстрый заказ до лучших времен
						<ul class="nav nav-tabs" role="tablist">
							<li role="presentation"><a href="#fast-order" aria-controls="home" role="tab" data-toggle="tab"><?php echo $text_quick_order; ?><i></i></a></li>
							<li role="presentation" class="active"><a href="#full-order" aria-controls="profile" role="tab" data-toggle="tab"><?php echo $text_standart_order; ?><i></i></a></li>
						</ul> -->

						<!-- Tab panes -->
						<div class="tab-content">

							<div role="tabpanel" class="tab-pane" id="fast-order">
								<form class="fast-form">
									...
									<div class="fast-rules">
										...
										<div role="tabpanel" class="tab-pane active" id="full-order">
										 <form class="long">
											<ol class="rules">
													...
													<li>
														...
														<select class="order-select" name="easycart-payment_method_text">
															<?php //foreach ($payment_methods as $payment_method) { ?>
																<option value="<?php echo $payment_cash; ?>"><?php echo $payment_cash; ?></option>
																<option value="<?php echo $payment_code; ?>"><?php echo $payment_code; ?></option>
																<option value="<?php echo $payment_cashless; ?>"><?php echo $payment_cashless; ?></option>
															<?php //} ?>
														</select>
													</li>
												<?php //} ?>
						...
						<div id="discount-wrap" class="col-md-6 col-xs-12 col-sm-12 col-md-offset-6" hidden="true">
							<div class="discount" hidden="true">
