    ...
    <tbody>
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><b><?php echo $text_order_id; ?></b> <?php echo $order_id; ?><br />
          ...
          <b><?php echo $text_payment_method; ?></b> <?php echo $payment_method1; ?><br />
          <?php if ($shipping_method) { ?>
          <b><?php echo $text_shipping_method; ?></b> <?php echo $shipping_method; ?><br />
          <?php } ?>
          <b><?php echo $text_city1; ?></b> <?php echo $city1; ?><br /> 
          <?php if ($company) { ?>
          <b><?php echo $text_company; ?></b> <?php echo $company; ?><br />
          <?php } ?>
          <?php if ($postcode) { ?>
          <b><?php echo $text_postcode; ?></b> <?php echo $postcode; ?><br />
          <?php } ?>

          <?php /*<b><?php echo $text_order_status; ?></b> <?php echo $order_status; ?><br /> */?>
        </td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;">
          ...
          <b><?php echo $text_comment1; ?></b> <?php echo $comment1; ?><br />
  ...
  <table style="border-collapse: collapse; width: 100%; border-top: 1px solid #DDDDDD; border-left: 1px solid #DDDDDD; margin-bottom: 20px;">
    <thead>
      <tr>
        ...
        <td style="font-size: 12px; border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; background-color: #EFEFEF; font-weight: bold; text-align: left; padding: 7px; color: #222222;"><?php echo $text_code; ?></td>
    ...
    <tbody>
      ...
      <tr>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $product['name']; ?>
          ...
          <br />
          &nbsp;<small> - <?php echo $option_language; ?>: <?php echo $option['value']; ?></small>
          </td>
        <td style="font-size: 12px;	border-right: 1px solid #DDDDDD; border-bottom: 1px solid #DDDDDD; text-align: left; padding: 7px;"><?php echo $option['code']; ?>
        <?php } ?>
        </td>
    ...
    <tfoot>
      ...
      <!-- вывод только если ненулевой итог -->
      	<?php if ("0,00" !== $total['text']) { ?>
      <tr>
...
<p style="margin-top: 0px; margin-bottom: 20px;"><?php echo $text_map1; ?> <a href="https://goo.gl/7HXmYv" target="_blank">https://goo.gl/7HXmYv</a></p>
<?php if($shipping_method == "Самовивіз" || $shipping_method == "Самовывоз"){ ?>
 <p style="margin-top: 0px; margin-bottom: 20px;">Оплата - только безналичным расчетом!</p>
<?php } ?>
</div>
</body>
</html>
