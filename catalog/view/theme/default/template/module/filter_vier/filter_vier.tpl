    ...
    <?php foreach($view_posit as $view_get => $view_val) {
        ...
        <?php } elseif($view_get == 'prs') { // prices ?>
            ...
            <div class="block_fv <?php echo $view_get; ?>">
                <div class="block_param">
                    <div class="filter_title expanded">цена</div>
                    <?php if($text_title) { ?>
                        ...
                        <div class="slider_attrib">
                            <div class="block_sl input_blok">
                                <table class="width_100_pr input_slider">
                                    <tr>
                                        <td class="filter_col">
                                            <label>От</label>
                                            <input name="prs[min]" id="left_count" class="form-control" type="text" value=""/></td>
                                        <td class="symbol_sld"><?php if(!$del_symbol) { ?>
                                        <span><?php echo $symbol; ?></span>
                                        <?php } ?></td>
                                        <td class="filter_col">
                                            <label>До</label>
                                            <input name="prs[max]" id="right_count" class="form-control" type="text" value=""/></td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="block_sl height_prim">
                                <table class="width_100_pr">
                                    <tr>
                                        <td id="cler_prs">
                                            <?php if($es_sl && $clear_sl) { ?><!-- <span class="text_clears"><a class="clear_slider btn btn_bordered" href="<?php echo $base_prs['del_href']; ?>"><?php echo $legend_clears; ?></a></span> --><?php } ?>
                                            <span class="text_clears"><a class="clear_slider btn btn_bordered" href="<?php echo $clear_filter; ?>"><?php if (empty($legend_clears)) { echo "Сбросить"; } else { echo $legend_clears; } ?></a></span>
                                        </td>
                                        <?php if(!$ajax_filter) { ?>
                                        <td><div id="prim_prs" class="button_slider btn btn_grad">
        ...
        <?php } elseif($view_get == 'attrb') { //attributes ?>
            ...
            <div class="block_fv <?php echo $view_get; ?>">
                ...
                <?php }
                    ...
                    <?php if($flag_select) { ?>
                        <select class="form-control"<?php echo ($ajax_filter) ? '' : ' onchange="location=this.value;"'; ?>>
                ...
                <?php } else {  // end slider_attrib
                    ...
                    <?php } elseif($flag_image) { $src_img = $val['image']; $src_null = ($src_img) ? null : $cls_no_src; ?>
            ...
            <?php foreach($view_optv as $option) { if($count_not_dislay && ($option['count_param'] < $count_not_dislay)) continue; ?>
                <div class="block_param">
                    <?php
                        ...
                        $dislay_fv = $option['dislay_fv'];
                        $dislay = $option['dislay'];
                        if(($dislay == 'select') && $option['action'] && !$ajax_filter) {
                            $dislay_fv .= ' act_sel';
                        }
                    ...
                    <?php if($dislay == 'select') { ?>
                        <select class="form-control"<?php echo ($ajax_filter) ? '' : ' onchange="location=this.value;"'; ?>>
                            <option disabled="disabled" selected="selected" style="display:none;">- - -</option>
                            <?php $tec_main_id = null; $tec_param_id = null; $del_href = $option['action'];
            ...
            <div class="block_fv <?php echo $view_get; ?>">
                <div class="block_param">
                    ...
                    <?php }
                        ...
                        ?>
                    <div class="onli_param blok<?php echo $css_hide, $css_scrl.' '.$manufs_display_fv; ?>">
                    <?php if($manufs_display == 'select') { ?>
                        <select class="form-control"<?php echo ($ajax_filter) ? '' : ' onchange="location=this.value;"'; ?>>
                            <option disabled="disabled" selected="selected" style="display:none;">- - -</option>
                            <?php $tec_main_id = null; $tec_param_id = null; $del_href = null;
                    ...
                    <?php $i = 0;
                        ...
                        <?php } elseif($manufs_display == 'button') { ?>
                            <div class="botton_opts">
                                <?php if($val['total'] == 0) { ?>
                                <label><span class="botton_fv <?php echo $cls_btn; ?> css_disabled"><?php echo $name_text; ?></span></label>
                                <?php } else {
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#mobil_mini').on('click', function() {
            ...
            if($('.column-filter').hasClass('hidden-xs')) {$('.column-filter').removeClass('hidden-xs');}
			$('.column-filter').toggle('hidden-xs');
		});
        /*end fix_mobil_mini*/
    });
</script>
<?php if($ajax_filter) { ?>
<script>
    <?php if($ajax_bloc_absolut && $ajax_bloc_mobil_versi) { ?>
