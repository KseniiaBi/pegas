...
<section class="register_inner centered">

    <div class="simple-content register_form">
<!-- заменить заголовки -->
    <h2>Регистрация</h2>
...
<?php } ?>
    ...
    <?php } ?>
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="simplepage_form" class="register" >
            <div class="simpleregister" id="simpleregister">
                ...
                <div class="simpleregister-block-content">
                    <?php foreach ($rows as $row) { $row = str_replace(array('col-sm-2','col-sm-10'), array('col-sm-4','col-sm-8'), $row); ?>
                      <?php echo $row ?>
                    <?php } ?>
                ...
                <div class="simpleregister-button-block buttons">
                    <div class="simpleregister-button-right">
                        ...
                        <?php } ?>
                        <a class="button btn_grad btn" data-onclick="submit" id="simpleregister_button_confirm"><span><?php echo $button_continue; ?></span></a>
                    </div>
                </div>
            </div>
            <?php if ($redirect) { ?>
    ...
    <div class="goto_register">
        ...
        <a href="my-account/" class="btn btn_grad">Уже есть аккаунт?</a>
    </div>
