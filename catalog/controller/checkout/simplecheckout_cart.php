...
class ControllerCheckoutSimpleCheckoutCart extends SimpleController {
    ...
    public function index() {
        ...
        $this->_templateData['alrt'] = ($this->config->get('config_language_id') == 2)?"Окончательную сумму со всеми скидками озвучивает оператор":"Кінцеву суму зі всіма знижками оголошує оператор";
        ...
        $this->_templateData['text_seria'] = $this->language->get('text_seria');
        ...
        foreach ($products as $product) {
            ...
            if ($version >= 200) {
                ...
                $product_filters = $this->model_catalog_product_filters->getProductFilters($product['product_id']);
                // echo "<pre>";
