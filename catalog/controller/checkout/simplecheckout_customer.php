...
class ControllerCheckoutSimpleCheckoutCustomer extends SimpleController {
    ...
    public function index() {
        ...
        $this->_templateData['rules']       = $this->language->get('rules');
        ...
        $this->_templateData['text_r_register']              = $this->language->get('text_r_register');
        $this->_templateData['text_r_descr']                 = $this->language->get('text_r_descr');
        ...
        $this->_templateData['logged'] = true;
        if (!$this->customer->getId()) {
            $this->_templateData['logged'] = false;
            $this->_templateData['simplecheckout_login'] = $this->getChildController('checkout/simplecheckout_login');
        }
