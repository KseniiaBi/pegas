...
class ControllerCheckoutSimpleCheckoutLogin extends SimpleController {
    ...
    public function index() {
        ...
        $this->_templateData['text_n_account']                = $this->language->get('text_n_account');
        $this->_templateData['text_n_descr']                  = $this->language->get('text_n_descr');
        $this->_templateData['text_n_create']                 = $this->language->get('text_n_create');
        $this->_templateData['text_remember']                 = $this->language->get('text_remember');
        ...
        $this->_templateData['create'] = $this->url->link('account/simpleregister', '', 'SSL');
