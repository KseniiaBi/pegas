		...
		foreach ($results as $result) {
			...
			foreach ($products as $product) {
				...
				$products_data[] = array(
					'name'     => $product['name'],
					'model'    => $product['model'],
					'thumb'    => $this->model_tool_image->resize($product_info['image'], 106, 132),
					'option'   => $option_data,
					...
					'reorder'  => $reorder,
					'filters'  => $this->model_catalog_product_filters->getProductFilters($product['product_id']),
			...
			$data['orders'][] = array(
				...
				'shipping_address' => $result['payment_city'] . ' ' . $result['payment_address_1'],
				'date_added' => date($this->language->get('date_format_short'), strtotime($result['date_added'])),
				'products'   => $products_data,
				'total'      => $this->currency->format($result['total'], $result['currency_code'], $result['currency_value']),
				'totals'	 => $data_total,
				'reorder'    => $this->url->link('account/order/reorder', 'order_id=' . $order_id, 'SSL'),
