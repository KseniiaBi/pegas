<?php
class ControllerFeedUnixmlPegas extends Controller {
  ...
  private function formProducts($products_query,$additional_params,$lang,$multiply_options_status,$multiply_options_id){
    ...
    foreach($products_query as $product){
      ...
      if($multiply_options_status) {
        $options = $this->db->query("SELECT ovd.name as value, od.name, pov.price_prefix, pov.price  FROM " . DB_PREFIX . "option_description od INNER JOIN " . DB_PREFIX . "option_value_description " .
