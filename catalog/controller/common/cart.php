...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		$data['text_items'] = sprintf($this->language->get('text_items'), (int)$this->currency->format($total));
		...
		$data['active_cart'] = (bool)count($data['products']);
		// Gift Voucher
		$data['vouchers'] = array();
	...
	public function info() {
		...
		$this->response->setOutput(sprintf($this->language->get('text_items'), (int)$this->currency->format($total)));
	}
}
